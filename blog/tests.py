...
class TestView(TestCase):
    def setUp(self):
        ...
        self.user_obaba = User.objects.create_user(
            username="obama", password="somepassword"
        )
        self.user_obaba.is_staff = True
        self.user_obaba.save()
        ...
        self.comment_001 = Comment.objects.create(
            post=self.post_001, author=self.user_obaba, content="첫 번째 댓글입니다."
        )
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.user_obaba.username.upper(), main_area.text)
